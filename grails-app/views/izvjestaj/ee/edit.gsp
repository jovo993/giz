    ...
    <form id="formIzvjestaj">
        <fieldset <g:if test="${!izvjestaj.status.equals(ba.giz.IzvjestajStatus.KREIRAN) && !izvjestaj.status.equals(ba.giz.IzvjestajStatus.DORADA)}">disabled=""</g:if>>
            ...
            <fieldset class="fieldset">
                <g:hiddenField id="id" name="izvjestaj.id" value="${id}"/>
    ...
    <g:javascript library='jquery'>
        (function($) {
            $(document).ready(function() {
                ...
                var $DORADABTN = $('#vratiNaDoraduButton');
                var $VERIFYBTN = $('#verifikujButton');
                ...
                $DORADABTN.click(function() {
                    ...
                    dataJSON += createJSONData("izvjestaj.preuzetaIsporucenaEEList", $TABLE1);
                    dataJSON += createJSONData("izvjestaj.procjenaStanjaEnergetskeEfikasnostiList", $TABLE2);
                    var url="${createLink(controller: 'izvjestaj', action: 'vratiNaDoradu')}";
                ...
                $VERIFYBTN.click(function() {
                    ...
                    dataJSON += createJSONData("izvjestaj.preuzetaIsporucenaEEList", $TABLE1);
                    dataJSON += createJSONData("izvjestaj.procjenaStanjaEnergetskeEfikasnostiList", $TABLE2);
                    var url="${createLink(controller: 'izvjestaj', action: 'verifikuj')}";
