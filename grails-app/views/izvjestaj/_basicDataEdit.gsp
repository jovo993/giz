...
<fieldset class="fieldset" disabled>
    ...
    <g:textField name="izvjestaj.preduzece.naziv" value="${izvjestaj?.preduzece?.naziv}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.sektor"><g:message code="preduzece.sektor.title"/></label>
    <g:select name="izvjestaj.preduzece.sektor" from="${ba.giz.Sektor.values()}" value="${izvjestaj?.preduzece?.sektor}" style="width: 50%"/><br/>

    <label>
        <g:message code="preduzece.uloga.title"/>
    </label>
    <g:textField name="uloga" value="${izvjestaj?.preduzece?.uloga}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.adresa"><g:message code="preduzece.adresa.title"/></label>
    <g:textField name="izvjestaj.preduzece.adresa" value="${izvjestaj?.preduzece?.adresa}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.maticniBrojJedinstvenogRegistra"><g:message code="preduzece.maticni.title"/></label>
    <g:textField name="izvjestaj.preduzece.maticniBrojJedinstvenogRegistra" value="${izvjestaj?.preduzece?.maticniBrojJedinstvenogRegistra}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.jib"><g:message code="preduzece.jib.title"/></label>
    <g:textField name="izvjestaj.preduzece.jib" value="${izvjestaj?.preduzece?.jib}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.pib"><g:message code="preduzece.pib.title"/></label>
    <g:textField name="izvjestaj.preduzece.pib" value="${izvjestaj?.preduzece?.pib}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.telefon"><g:message code="preduzece.telefon.title"/></label>
    <g:textField name="izvjestaj.preduzece.telefon" value="${izvjestaj?.preduzece?.telefon}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.fax"><g:message code="preduzece.fax.title"/></label>
    <g:textField name="izvjestaj.preduzece.fax" value="${izvjestaj?.preduzece?.fax}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.email"><g:message code="preduzece.email.title"/></label>
    <g:textField name="izvjestaj.preduzece.email" value="${izvjestaj?.preduzece?.email}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.brojZaposlenih"><g:message code="preduzece.brojzaposlenih.title"/></label>
    <g:textField name="izvjestaj.preduzece.brojZaposlenih" value="${izvjestaj?.preduzece?.brojZaposlenih}" style="width: 50%"/><br/>

    <label for="izvjestaj.preduzece.ukupanGodisnjiPromet"><g:message code="preduzece.promet.title"/></label>
    <g:textField name="izvjestaj.preduzece.ukupanGodisnjiPromet" value="${izvjestaj?.preduzece?.ukupanGodisnjiPromet}" style="width: 50%"/><br/>
...
<g:textField name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.distribucijaRegistarskiBroj" value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.distribucijaRegistarskiBroj}" style="width: 50%"/><br/>
...
<g:textField name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.distribucijaKomisija" value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.distribucijaKomisija}" style="width: 50%"/><br/>
...
<input name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.distribucijaDatumPocetkaVazenje" type="date"
       value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.distribucijaDatumPocetkaVazenje?.format("yyyy-mm-dd")}" style="width: 50%"/><br/>
...
<g:textField name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.distribucijaPeriodVazenja" value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.distribucijaPeriodVazenja}" style="width: 50%"/><br/>
...
<g:textField name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeRegistarskiBroj" value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.snabdijevanjeRegistarskiBroj}" style="width: 50%"/><br/>

<label for="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeKomisija">
    ${title2}
</label>
<g:textField name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeKomisija" value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.snabdijevanjeKomisija}" style="width: 50%"/><br/>
...
<input name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeDatumPocetkaVazenje" type="date"
       value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.snabdijevanjeDatumPocetkaVazenje?.format("yyyy-mm-dd")}" style="width: 50%"/></br>
...
<g:textField name="izvjestaj.podaciDozvolaObavljanjeDjelatnosti.snabdijevanjePeriodVazenja" value="${izvjestaj?.podaciDozvolaObavljanjeDjelatnosti?.snabdijevanjePeriodVazenja}" style="width: 50%"/><br/>
</fieldset>
...
<fieldset class="fieldset">
    ...
    <g:select name="izvjestaj.podaciPodnosenjeIzvjestaja.godina" from="${ba.giz.Godina.findAll()}" value="${izvjestaj?.podaciPodnosenjeIzvjestaja?.godina}" style="width: 50%"/><br/>
    ...
    <g:textField name="izvjestaj.podaciPodnosenjeIzvjestaja.prezimeImePozicija" value="${izvjestaj?.podaciPodnosenjeIzvjestaja?.prezimeImePozicija}" style="width: 50%"/><br/>

    <label for="izvjestaj.podaciPodnosenjeIzvjestaja.telefon"><g:message code="podaciPodnosenjeIzvjestaja.telefon.title"/></label>
    <g:textField name="izvjestaj.podaciPodnosenjeIzvjestaja.telefon" value="${izvjestaj?.podaciPodnosenjeIzvjestaja?.telefon}" style="width: 50%"/><br/>

    <label for="izvjestaj.podaciPodnosenjeIzvjestaja.email"><g:message code="podaciPodnosenjeIzvjestaja.email.title"/></label>
    <g:textField name="izvjestaj.podaciPodnosenjeIzvjestaja.email" value="${izvjestaj?.podaciPodnosenjeIzvjestaja?.email}" style="width: 50%"/><br/>
</fieldset>