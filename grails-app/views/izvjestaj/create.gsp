...
<div id="create-izvjestaj" class="content scaffold-create" role="main">
    ...
    <g:applyLayout name="singleblock">
        <g:form controller="izvjestaj" action="save">
            ...
            <content tag="set2">
                ...
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.distribucijaRegistarskiBroj"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.distribucijaRegistarskiBroj.title')}"/>
                ...
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.distribucijaDatumPocetkaVazenje"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.distribucijaDatumPocetkaVazenje.title')}"/>
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.distribucijaPeriodVazenja"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.distribucijaPeriodVazenja.title')}"/>
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeRegistarskiBroj"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeRegistarskiBroj.EE.title')}"/>
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeKomisija"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeKomisija.title')}"/>
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeDatumPocetkaVazenje"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.snabdijevanjeDatumPocetkaVazenje.title')}"/>
                <f:field bean="izvjestaj" property="podaciDozvolaObavljanjeDjelatnosti.snabdijevanjePeriodVazenja"
                         label="${message(code: 'podaciDozvolaObavljanjeDjelatnosti.snabdijevanjePeriodVazenja.title')}"/>
            </content>
