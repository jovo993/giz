...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'godina.label', default: 'Godina')}" />
    ...
    <body>
        ...
        <div id="edit-godina" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.godina}" method="PUT">
                <g:hiddenField name="version" value="${this.godina?.version}" />
                <fieldset class="form">
                    <f:all bean="godina"/>
                </fieldset>
