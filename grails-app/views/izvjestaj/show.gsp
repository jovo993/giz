...
<div id="create-izvjestaj" class="content scaffold-create" role="main">
    ...
    <g:form action="update" controller="izvjestaj">
        <fieldset class="fieldset">
            ...
            <label for="preduzece.sektor">
                <g:message code="preduzece.sektor.title"/>
            </label>
            <f:field bean="izvjestaj" property="preduzece.sektor" >
                <g:select name="preduzece.sektor" from="${ba.giz.Sektor.values()}" value="${izvjestaj?.preduzece?.sektor}" optionValue=""/><br/>
            </f:field>
        ...
        <fieldset class="buttons">
            <g:submitButton name="edit" class="save" value="${message(code: 'default.button.edit.label', default: 'Create')}" />
        </fieldset>
    </g:form>
